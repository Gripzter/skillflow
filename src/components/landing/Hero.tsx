    ...
    <section className="mx-auto grid w-full max-w-[1200px] grid-cols-1 gap-10 px-8 pb-[100px] pt-20 md:grid-cols-[1.1fr_1fr] md:gap-12">
      <div>
        ...
        <h1 className="mt-6 text-[40px] font-medium leading-[1.05] tracking-[-2px] text-white md:text-[64px]">
          ...
          <span className="block text-[#FFFF00]">Earn your spot.</span>
        </h1>
        ...
        <div className="mt-8 flex flex-wrap gap-3">
          <button
            type="button"
            onClick={() => goTo("/signup")}
            className="rounded-[8px] bg-[#FFFF00] px-6 py-3.5 text-[14px] font-medium text-[#0E0E12] transition-colors hover:bg-[#E6E600]"
          >
            Play now →
          </button>
          <button
            ...
            className="rounded-[8px] border border-[#2a2a35] px-6 py-3.5 text-[14px] font-medium text-white transition-colors hover:border-[#FFFF00]"
          >
            Join Founders
          </button>
        </div>

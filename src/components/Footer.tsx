...
export default function Footer() {
  return (
    <footer className="card-border border-t border-white/5 px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="flex gap-6">
          {socialIcons.map((s) => (
            <a
              key={s.label}
              href={s.href}
              className="text-body-gray transition-colors hover:text-teal"
              aria-label={s.label}
            >
              {s.icon}
            </a>
      ...
      <p className="mx-auto mt-8 max-w-6xl text-center text-sm text-body-gray">

...
export const SKILL_POINTS_NAME = "Skillies";
export const SKILL_POINTS_ICON = "SK";
...
export const PRIZE_POOL_BANNER_TEXT =
  "Beta Season Live — Stake Skillies. Climb the Glicko leaderboard. Unlock Founders Rewards.";
